export default {
  ...
  'eyetracker.calibration_params': 'Calibration',
  'eyetracker.page_calibration': 'Activate per-page calibration',
  'eyetracker.calibration-points-per-line': 'Calibration points per line',
  'eyetracker.validation_procedure': 'Validation procedure',
  'eyetracker.central': 'Central (Short)',
  'eyetracker.peripheral': 'Peripheral (Long)',
  'eyetracker.both': 'Combined (Central + Peripheral)',
